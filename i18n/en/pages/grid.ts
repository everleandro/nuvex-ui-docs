...
export const gridComponentContent: DocsComponentPageContent = {
  ...
  seo: {
    title: "Grid",
    description:
      "Grid component documentation for Nuvex UI with interactive usage, responsive breakpoints, row modes, nested layouts, and API reference for ERow and ECol.",
  },
  hero: {
    title: "Grid",
    descriptionHtml:
  ...
  labels: {
    controls: [
      ...
      {
        key: "rowProperties",
        label: '<code class="docs-inline-code">ERow</code> Properties',
      },
      {
        key: "colProperties",
        label: '<code class="docs-inline-code">ECol</code> Properties',
      },
    ],
    gridText: {
      previewTitle: "Grid preview",
      previewDescription:
        "Interactive layout sample using three responsive columns.",
      columnA: "Column A",
      columnB: "Column B",
      columnC: "Column C",
      columnDescription:
        "Replace these cards with your page sections, stats, or forms.",
      responsiveMainTitle: "Main content",
      responsiveMainDescription:
        "Spans most of the row on medium and large screens.",
      responsiveAsideTitle: "Sidebar",
      responsiveAsideDescription:
      ...
      rowModesEqualDescription:
        "Forces sibling columns to share available width.",
      rowModesNoGuttersTitle: "no-gutters",
      rowModesNoGuttersDescription:
        "Removes gutters when cards must touch edges.",
