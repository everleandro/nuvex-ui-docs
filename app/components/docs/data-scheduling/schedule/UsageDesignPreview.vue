<template>
    <ESchedule v-model="date" v-model:scale="scale" class="full-width" :spaces="spaces"
        :selected-space="spaces[0]" :events="events" :start="9 * 60 * 60" :end="14 * 60 * 60" :row-height="64"
        elevation="sm" />
</template>
