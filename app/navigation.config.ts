...
export const navigationGroups: NavigationGroupItem[] = [
  ...
  ]),
  {
    ...
    icon: 'components',
    entries: [
      { kind: 'header', id: 'core-actions-header', titleKey: 'navigation.subgroups.core_actions' },
      createLink('forms-button', 'navigation.items.core_actions.button', '/docs/component/core-actions/button', 'core-actions', 'navigation.subgroups.core_actions'),
      { kind: 'divider', id: 'core-actions-divider' },
      { kind: 'header', id: 'form-foundations-header', titleKey: 'navigation.subgroups.form_foundations' },
      createLink('forms-form', 'navigation.items.form_foundations.form', '/docs/component/form-foundations/form', 'form-foundations', 'navigation.subgroups.form_foundations'),
      { kind: 'divider', id: 'form-foundations-divider' },
      { kind: 'header', id: 'form-inputs-header', titleKey: 'navigation.subgroups.form_inputs' },
      createLink('forms-text-field', 'navigation.items.form_inputs.text_field', '/docs/component/form-inputs/text-field', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('forms-textarea', 'navigation.items.form_inputs.textarea', '/docs/component/form-inputs/textarea', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('forms-select', 'navigation.items.form_inputs.select', '/docs/component/form-inputs/select', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('forms-checkbox', 'navigation.items.form_inputs.checkbox', '/docs/component/form-inputs/checkbox', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('forms-radio', 'navigation.items.form_inputs.radio', '/docs/component/form-inputs/radio', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('forms-switch', 'navigation.items.form_inputs.switch', '/docs/component/form-inputs/switch', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('data-scheduling-date-picker', 'navigation.items.form_inputs.date_picker', '/docs/component/form-inputs/date-picker', 'form-inputs', 'navigation.subgroups.form_inputs'),
      createLink('data-scheduling-time-picker', 'navigation.items.form_inputs.time_picker', '/docs/component/form-inputs/time-picker', 'form-inputs', 'navigation.subgroups.form_inputs'),
      { kind: 'divider', id: 'form-inputs-divider' },
      ...
      { kind: 'header', id: 'data-display-scheduling-header', titleKey: 'navigation.subgroups.data_display_scheduling' },
